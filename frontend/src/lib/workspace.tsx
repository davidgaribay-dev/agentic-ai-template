...
export function WorkspaceProvider({ children }: WorkspaceProviderProps) {
  ...
  const refresh = useCallback(() => {
    ...
    if (currentOrgId) {
      queryClient.invalidateQueries({ queryKey: workspaceKeys.teams(currentOrgId) })
      queryClient.invalidateQueries({ queryKey: workspaceKeys.membership(currentOrgId) })
      queryClient.invalidateQueries({ queryKey: ["workspace", "my-membership", currentOrgId] })
    }
